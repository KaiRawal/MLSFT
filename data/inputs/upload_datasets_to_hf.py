...
Reads from fine_tuning/ and eval_prompts/ subdirectories, formats data with language fields,
...
FINE_TUNING_DIR = SCRIPT_DIR / "fine_tuning"
EVAL_PROMPTS_DIR = SCRIPT_DIR / "eval_prompts"
...
def load_eval_data() -> pd.DataFrame:
    ...
    dfs = []
    csv_files = sorted(EVAL_PROMPTS_DIR.glob("MLSFT - *Evaluation*.csv"))
