...
echo "Using fixed base model: unsloth/Ministral-3-14B-Instruct-2512"
...
run_language_pipeline() {
  ...
  local repo_name="Ministral-3-14B-Instruct-2512-${lang_code}-SynthDolly-1A"
...
{
  "model_path": "unsloth/Ministral-3-14B-Instruct-2512",
