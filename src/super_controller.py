...
Usage:
    python src/super_controller.py --model-name unsloth/qwen3-0.6B
    python src/super_controller.py --model-name unsloth/qwen3-0.6B --run
"""
...
def main() -> int:
    ...
    for lang in langs:
        for seed_idx in seeds:
            ...
            ft_cfg = {
                ...
                "input_csv": f"data/inputs/fine_tuning/{lang.name}_finetuning_data.csv",
            ...
            tr_cfg = {
                ...
                "local_prompt_csv": f"data/inputs/eval_prompts/{lang.name}_evaluation_prompts.csv",
    ...
    preflight_code = run_cmd(["python", "src/preflight_check.py"], preflight_log)
    execution.append(
        {
            "stage": "preflight",
    ...
    stage_script = {
        "fine_tuning": "src/mls_fine_tuning_with_templates.py",
        "eval_english": "src/mls_eval_english.py",
        "eval_translated": "src/nllb_200_mls_run_sorry_bench_with_translated_prompts.py",
    }
